                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(texts[index],style: GoogleFonts.niramit(fontSize: 18,fontWeight: FontWeight.w700),),
                                  ),
                                ),
                                Visibility(
                          ...
                          Padding(
                            ...
                            child: TextField(
                              decoration: InputDecoration(
                                  ...
                                  hintStyle: TextStyle(fontSize: 16,color: HexColor("#055C9D"))
                              ),
                            ),
                          )
                        ],
