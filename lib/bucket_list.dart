...
import 'package:tramper/profile.dart';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              width: double.infinity,
              decoration: BoxDecoration(
                  image: DecorationImage(image: AssetImage("asset/img_7.png",),fit: BoxFit.fill)
              ),
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text("BUCKET LIST",style: GoogleFonts.marcellusSc(fontWeight: FontWeight.w400,fontSize: 25,decoration: TextDecoration.underline),),
                  ),
                  SizedBox(
                    height: 685,
